...
static ShaderProgram g_ShaderHandle;
...
void Render() {
	...
	Mat4 proj = glm::make_mat4(ortho_projection);
...
bool CreateDeviceObjects()
{
	...
	g_ShaderHandle = Builder<ShaderProgram>::build()
					 .add(vertex_shader, ShaderType::VertexShader)
					 .add(fragment_shader, ShaderType::FragmentShader);
	g_ShaderHandle.link();

	g_AttribLocationPosition = g_ShaderHandle.getAttributeLocation("Position");
	g_AttribLocationUV = g_ShaderHandle.getAttributeLocation("UV");
	g_AttribLocationColor = g_ShaderHandle.getAttributeLocation("Color");
...
void InvalidateDeviceObjects() {
	...
	Builder<ShaderProgram>::destroy(g_ShaderHandle);
