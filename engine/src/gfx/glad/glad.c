...
OpenGL loader generated by glad 0.1.18a0 on Fri Apr 13 00:28:48 2018.
...
Commandline:
--profile="compatibility" --api="gl=3.3" --generator="c" --spec="gl" --local-files --omit-khrplatform --extensions="GL_ARB_debug_output"
Online:
